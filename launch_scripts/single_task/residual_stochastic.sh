...
declare -A CHECKPOINTS=(
  # ["libriasr"]="libriasr_residual_400_stochastic/202502172132/checkpoint_29.pth"
  # ["librisqa"]="librisqa_residual_400_stochastic/202502172132/checkpoint_29.pth"
  # ["er"]="er_residual_400_stochastic/202502172132/checkpoint_29.pth"
  ["clotho_audio_cap"]="clotho_audio_cap_residual_400_stochastic/202502172132/checkpoint_29.pth"
  # ["cv_trans"]="
  # ["voxceleb_sv"]="
)

EVAL_DIR="evaluations/single_task/residual_stochastic/"
