...
declare -A CHECKPOINTS=(
  # ["libriasr"]="libriasr_att_400_stochastic/202502172132/checkpoint_29.pth"
  # ["librisqa"]="librisqa_att_400_stochastic/202502172132/checkpoint_29.pth"
  # ["er"]="er_att_400_stochastic/202502172133/checkpoint_29.pth"
  ["clotho_audio_cap"]="clotho_audio_cap_att_400_stochastic/202502172133/checkpoint_29.pth"
  # ["cv_trans"]="cv_trans_att_400_stochastic/202502172136/checkpoint_29.pth"
  # ["voxceleb_sv"]="voxceleb_sv_att_400_stochastic/202502172132/checkpoint_29.pth"
)

EVAL_DIR="evaluations/single_task/att_stochastic/"
  ...
  eai job new \
    ...
    -- bash -c "
        ...
        python3 train.py \
            ...
            model.l2p=True \
	    model.prompt_strategy=att_strategy \
	    model.pool_size=400 \
